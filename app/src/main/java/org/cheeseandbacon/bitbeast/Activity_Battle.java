...
public class Activity_Battle extends AppCompatActivity {
    ...
    @Override protected void onPause () {
        ...
        if (isFinishing()) {
            ...
            experience_points = (long) RNG.random_range((int) Pet_Status.EXPERIENCE_BASE_BATTLE_MIN,
                                                        (int) Pet_Status.EXPERIENCE_BASE_BATTLE_MAX);

            experience_points += Pet_Status.get_level_bonus_xp(pet_status.level, Pet_Status.EXPERIENCE_BONUS_BATTLE,
                                                               Pet_Status.EXPERIENCE_VIRTUAL_LEVEL_HIGH);

            if (won) {
                long experience_mod = (long) Math.ceil((double) (Pet_Status.get_level_bonus_xp(our_level,
                                                                                               Pet_Status.
                                                                                               EXPERIENCE_BONUS_BATTLE,
                                                                                               Pet_Status.
                                                                                               EXPERIENCE_VIRTUAL_LEVEL_HIGH)
                                                                 - Pet_Status.get_level_bonus_xp(their_level,
                                                                                                 Pet_Status.
                                                                                                 EXPERIENCE_BONUS_BATTLE,
                                                                                                 Pet_Status.
                                                                                                 EXPERIENCE_VIRTUAL_LEVEL_HIGH))
            ...
            if (!UnitConverter.is_weight_basically_zero(weight_loss_this_session, df)) {
                message_end = pet_status.name + " lost " + UnitConverter.get_weight_string(weight_loss_this_session,
                                                                                           df) + ".";
            }

            pet_status.sleeping_wake_up();

            Activity_Rewards.give_rewards(this, getPackageName(), pet_status, sound, message_begin, message_end,
                                          experience_points, bits, true, item_chance, their_level);
        }
    }
    ...
    public static void set_pet_stats (Resources res, TextView tv_us, TextView tv_them, Pet_Status us_data,
                                      Pet_Status them_data, short our_strength, short our_dexterity, short our_stamina,
                                      short their_strength, short their_dexterity, short their_stamina) {
        String message = "";
        ...
        message += "\n" + Pet_Status.get_buff_name("strength_max") + ": " + our_strength + "/" +
                   us_data.get_strength_max();
        ...
        message += "\n" + Pet_Status.get_buff_name("dexterity_max") + ": " + our_dexterity + "/" +
                   us_data.get_dexterity_max();
        ...
        message += "\n" + Pet_Status.get_buff_name("stamina_max") + ": " + our_stamina + "/" +
                   us_data.get_stamina_max();
        ...
        message += "\n" + Pet_Status.get_buff_name("strength_max") + ": " + their_strength + "/" +
                   them_data.get_strength_max();
        ...
        message += "\n" + Pet_Status.get_buff_name("dexterity_max") + ": " + their_dexterity + "/" +
                   them_data.get_dexterity_max();
        ...
        message += "\n" + Pet_Status.get_buff_name("stamina_max") + ": " + their_stamina + "/" +
                   them_data.get_stamina_max();
    ...
    public void initiate_battle () {
        ...
        if (battle) {
            ...
            short them_stat_max = (short) ((them.get_strength_max() + them.get_dexterity_max() +
                                            them.get_stamina_max()) / 3);

            // Determine a scale for bit gain based on relative stat level of the two pets.
            int bit_gain_mod = (int) Math.ceil(((double) us_stat_max - (double) them_stat_max) *
                                               Pet_Status.BIT_GAIN_BATTLE_LEVEL_SCALE_FACTOR);
            ...
            // Determine a scale for bit gain based on relative stat level of the two pets.
            bit_gain_mod = (int) Math.ceil(((double) them_stat_max - (double) us_stat_max) *
                                           Pet_Status.BIT_GAIN_BATTLE_LEVEL_SCALE_FACTOR);
        ...
        hits = Battle.battle(this, local_us, us, them, server, our_seed, their_seed, bits_reward_them,
                             bit_level_diff_bonus_them, shadow);
        ...
        set_pet_stats(res, (TextView) findViewById(R.id.battle_text_us), (TextView) findViewById(R.id.battle_text_them),
                      us, them, strength_us, dexterity_us, stamina_us, strength_them, dexterity_them, stamina_them);
