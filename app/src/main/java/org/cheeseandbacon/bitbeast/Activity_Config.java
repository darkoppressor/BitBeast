...
public class Activity_Config extends AppCompatActivity {
    ...
    @Override protected Dialog onCreateDialog (int id) {
        switch (id) {
            case DIALOG_ID_TIME:
                dialog_time = new TimePickerDialog(this, time_set_listener,
                                                   Options.desired_sleep_time.get(Calendar.HOUR_OF_DAY),
                                                   Options.desired_sleep_time.get(Calendar.MINUTE), false);
    ...
    public void update_time_button () {
        ...
        b.setText(getResources().getString(R.string.config_desired_sleep_time) +
                  Options.desired_sleep_time.get(Calendar.HOUR) + ":" + minutes + am_pm);

        dialog_time.updateTime(Options.desired_sleep_time.get(Calendar.HOUR_OF_DAY),
                               Options.desired_sleep_time.get(Calendar.MINUTE));
    }
