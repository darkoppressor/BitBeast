...
public class Activity_Dev extends AppCompatActivity{
    ...
    public void update(){
        final SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-mm-dd HH:mm:ss zzz", Locale.US);
        ...
        data.add("Wake time: " + simpleDateFormat.format(pet_status.wake_time.getTime()));
        data.add("Sleep time: " + simpleDateFormat.format(pet_status.sleep_time.getTime()));
        data.add("Should be sleeping: " + pet_status.sleeping);
        data.add("Awake during sleep time: " + pet_status.sleeping_woken_up);
        data.add("Last wake up during sleep: " + simpleDateFormat.format(new Date(pet_status.sleeping_woken_up_time)));
        ...
        data.add("Last base temperature update: " + simpleDateFormat.format(new Date(pet_status.last_base_temp)));
