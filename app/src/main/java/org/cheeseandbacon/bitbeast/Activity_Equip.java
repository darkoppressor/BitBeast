...
public class Activity_Equip extends AppCompatActivity {
    ...
    @Override public void onCreate (Bundle savedInstanceState) {
        ...
        Font.set_typeface(getAssets(),
                          (Button) dialog_details.findViewById(R.id.button_dialog_inventory_details_equip));
        Font.set_typeface(getAssets(),
                          (Button) dialog_details.findViewById(R.id.button_dialog_inventory_details_unequip));
    ...
    @Override protected Dialog onCreateDialog (int id) {
        ...
        switch (id) {
            case DIALOG_DETAILS:
                ...
                layout = inflater.inflate(R.layout.dialog_inventory_details,
                                          (ViewGroup) findViewById(R.id.root_dialog_inventory_details));
    ...
    public void update () {
        ...
        if (pet_status.equipment_slots.get(Equipment.SLOT_WEAPON) != null) {
            b.setText(Html.fromHtml(Strings.newline_to_br(pet_status.equipment_slots.get(
                                                              Equipment.SLOT_WEAPON).get_slot_string(this))));

            b.setCompoundDrawablesWithIntrinsicBounds(pet_status.equipment_slots.get(
                                                          Equipment.SLOT_WEAPON).get_template(this).resource_id, 0, 0,
                                                      0);
        } else {
            b.setText("Empty");
        ...
        b.setOnLongClickListener(new OnLongClickListener(){
            public boolean onLongClick(View view) {
                if (pet_status.equipment_slots.get(Equipment.SLOT_WEAPON) != null) {
                    String message =
                        pet_status.equipment_slots.get(Equipment.SLOT_WEAPON).get_details(getApplicationContext(),
                                                                                          pet_status.equipment_slots);
                    ...
                    tv.setCompoundDrawablesWithIntrinsicBounds(0, 0,
                                                               pet_status.equipment_slots.get(
                                                                   Equipment.SLOT_WEAPON).get_template(
                                                                   getApplicationContext()).resource_id, 0);
        ...
        if (pet_status.equipment_slots.get(Equipment.SLOT_HEAD) != null) {
            b.setText(Html.fromHtml(Strings.newline_to_br(pet_status.equipment_slots.get(
                                                              Equipment.SLOT_HEAD).get_slot_string(this))));

            b.setCompoundDrawablesWithIntrinsicBounds(pet_status.equipment_slots.get(Equipment.SLOT_HEAD).get_template(
                                                          this).resource_id, 0, 0, 0);
        } else {
            b.setText("Empty");
        ...
        b.setOnLongClickListener(new OnLongClickListener(){
            public boolean onLongClick(View view) {
                if (pet_status.equipment_slots.get(Equipment.SLOT_HEAD) != null) {
                    String message =
                        pet_status.equipment_slots.get(Equipment.SLOT_HEAD).get_details(getApplicationContext(),
                                                                                        pet_status.equipment_slots);
                    ...
                    tv.setCompoundDrawablesWithIntrinsicBounds(0, 0,
                                                               pet_status.equipment_slots.get(
                                                                   Equipment.SLOT_HEAD).get_template(
                                                                   getApplicationContext()).resource_id, 0);
        ...
        if (pet_status.equipment_slots.get(Equipment.SLOT_CHEST) != null) {
            b.setText(Html.fromHtml(Strings.newline_to_br(pet_status.equipment_slots.get(
                                                              Equipment.SLOT_CHEST).get_slot_string(this))));

            b.setCompoundDrawablesWithIntrinsicBounds(pet_status.equipment_slots.get(Equipment.SLOT_CHEST).get_template(
                                                          this).resource_id, 0, 0, 0);
        } else {
            b.setText("Empty");
        ...
        b.setOnLongClickListener(new OnLongClickListener(){
            public boolean onLongClick(View view) {
                if (pet_status.equipment_slots.get(Equipment.SLOT_CHEST) != null) {
                    String message =
                        pet_status.equipment_slots.get(Equipment.SLOT_CHEST).get_details(getApplicationContext(),
                                                                                         pet_status.equipment_slots);
                    ...
                    tv.setCompoundDrawablesWithIntrinsicBounds(0, 0,
                                                               pet_status.equipment_slots.get(
                                                                   Equipment.SLOT_CHEST).get_template(
                                                                   getApplicationContext()).resource_id, 0);
        ...
        if (pet_status.equipment_slots.get(Equipment.SLOT_FEET) != null) {
            b.setText(Html.fromHtml(Strings.newline_to_br(pet_status.equipment_slots.get(
                                                              Equipment.SLOT_FEET).get_slot_string(this))));

            b.setCompoundDrawablesWithIntrinsicBounds(pet_status.equipment_slots.get(Equipment.SLOT_FEET).get_template(
                                                          this).resource_id, 0, 0, 0);
        } else {
            b.setText("Empty");
        ...
        b.setOnLongClickListener(new OnLongClickListener(){
            public boolean onLongClick(View view) {
                if (pet_status.equipment_slots.get(Equipment.SLOT_FEET) != null) {
                    String message =
                        pet_status.equipment_slots.get(Equipment.SLOT_FEET).get_details(getApplicationContext(),
                                                                                        pet_status.equipment_slots);
                    ...
                    tv.setCompoundDrawablesWithIntrinsicBounds(0, 0,
                                                               pet_status.equipment_slots.get(
                                                                   Equipment.SLOT_FEET).get_template(
                                                                   getApplicationContext()).resource_id, 0);
    ...
    public void unequip_item (int position) {
        if (pet_status.equipment_slots.get(position) != null) {
            Sound_Manager.playSound(this, Sound.UNEQUIPPED);
    ...
    public void set_dialog_buttons () {
        ((Button) dialog_details.findViewById(R.id.button_dialog_inventory_details_ok)).setOnClickListener(
        ...
        ((Button) dialog_details.findViewById(R.id.button_dialog_inventory_details_unequip)).setOnClickListener(
            new View.OnClickListener() {
            @Override public void onClick(View v) {
        ...
        ((Button) dialog_details.findViewById(R.id.button_dialog_inventory_details_sell)).setOnClickListener(
            new View.OnClickListener() {
            @Override public void onClick(View v) {
                if (detail_position != -1) {
