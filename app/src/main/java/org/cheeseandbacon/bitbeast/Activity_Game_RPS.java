...
public class Activity_Game_RPS extends AppCompatActivity {
    ...
    @Override protected void onPause () {
        ...
        if (isFinishing()) {
            ...
            experience_points += (long) Math.ceil((double) experience_factor * 0.01 *
                                                  (double) Pet_Status.get_level_bonus_xp(pet_status.level,
                                                                                         Pet_Status.EXPERIENCE_BONUS_RPS,
                                                                                         Pet_Status.
    ...
    @Override protected Dialog onCreateDialog (int id) {
        ...
        switch (id) {
            case DIALOG_ID_GAME_DONE:
                ...
                View layout = inflater.inflate(R.layout.dialog_game_rps,
                                               (ViewGroup) findViewById(R.id.root_dialog_game_rps));
    ...
    public void end_game (int pc) {
        ...
        if (game_result == WIN) {
            happy_this_session += RNG.random_range(Pet_Status.HAPPY_GAIN_GAME_RPS_MIN,
                                                   Pet_Status.HAPPY_GAIN_GAME_RPS_MAX);

            bits_this_session += Age_Tier.scale_bit_gain(pet_status.age_tier,
                                                         RNG.random_range(Pet_Status.BIT_GAIN_RPS_MIN,
                                                                          Pet_Status.BIT_GAIN_RPS_MAX));
        }
    ...
    public void set_dialog_buttons () {
        ((Button) dialog_game_done.findViewById(R.id.button_dialog_game_rps_ok)).setOnClickListener(
