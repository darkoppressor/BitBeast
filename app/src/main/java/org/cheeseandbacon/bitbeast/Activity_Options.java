...
public class Activity_Options extends AppCompatActivity {
    ...
    @Override protected Dialog onCreateDialog (int id) {
        switch (id) {
            case DIALOG_ID_RESET:
                ...
                View layout = inflater.inflate(R.layout.dialog_options_reset,
                                               (ViewGroup) findViewById(R.id.root_dialog_options_reset));
    ...
    public void set_dialog_buttons () {
        ((Button) dialog_reset.findViewById(R.id.button_dialog_options_reset_yes)).setOnClickListener(
        ...
        ((Button) dialog_reset.findViewById(R.id.button_dialog_options_reset_no)).setOnClickListener(
            new View.OnClickListener() {
            @Override public void onClick(View v) {
                if (dialog_reset.isShowing()) {
                    dismissDialog(DIALOG_ID_RESET);
