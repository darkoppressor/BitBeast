...
public class Activity_Records extends AppCompatActivity {
    ...
    @Override protected void onResume () {
        ...
        message += "\nTotal singleplayer battle win/loss ratio: " + records.get_battles_won_sp() + ":" +
                   records.get_battles_lost_sp();
        message += "\nTotal multiplayer battle win/loss ratio: " + records.get_battles_won() + ":" +
                   records.get_battles_lost();
        ...
        for (int i = 0; i < records.pets.size(); i++) {
            ...
            message += "\n" + this.getString(R.string.status_age) +
                       Time_String.seconds_to_years(records.pets.get(i).age);
            message += "\n" + this.getString(R.string.status_type) +
                       Strings.first_letter_capital(records.pets.get(i).type.toString());
            message += "\n" + this.getString(R.string.status_weight) +
                       UnitConverter.get_weight_string(records.pets.get(i).weight, df);
            ...
            message += "\n" + this.getString(R.string.status_winloss_sp) + records.pets.get(i).battles_won_sp + ":" +
                       records.pets.get(i).battles_lost_sp;
            message += "\n" + this.getString(R.string.status_winloss) + records.pets.get(i).battles_won + ":" +
                       records.pets.get(i).battles_lost;
        }
