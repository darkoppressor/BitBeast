...
public class Activity_Rewards extends AppCompatActivity {
    ...
    public static Bundle rewards_bundle (Context context, String package_name, Pet_Status status, int sound,
                                         String message_begin, String message_end, long experience_points, int bits,
                                         boolean add_bits, int equip_chance, int base_level) {
    ...
    public static void give_rewards_handler (Context context, Handler handler, String package_name, Pet_Status status,
                                             int sound, String message_begin, String message_end,
                                             long experience_points, int bits, boolean add_bits, int equip_chance,
                                             int base_level) {
        Bundle bundle = rewards_bundle(context, package_name, status, sound, message_begin, message_end,
                                       experience_points, bits, add_bits, equip_chance, base_level);
    ...
    public static void give_rewards (Context context, String package_name, Pet_Status status, int sound,
                                     String message_begin, String message_end, long experience_points, int bits,
                                     boolean add_bits, int equip_chance, int base_level) {
        Bundle bundle = rewards_bundle(context, package_name, status, sound, message_begin, message_end,
                                       experience_points, bits, add_bits, equip_chance, base_level);
    ...
    public void button_item (View view) {
        ...
        tv.setCompoundDrawablesWithIntrinsicBounds(0, 0,
                                                   pet_status.equipment.get(0).get_template(
