...
public class AnimatedSprite {
    ...
    public void Initialize (View view, Image image, int w, int h, Bitmap get_bitmap, int get_animation_speed,
                            int get_frame_count, boolean get_anim_fuzzy) {
        bitmap = get_bitmap;
        rect.top = 0;
        rect.bottom = h;
        rect.left = 0;
    ...
    public void draw (Canvas canvas, Resources res, int x, int y, int w, int h, int facing, int color, boolean flip_y,
