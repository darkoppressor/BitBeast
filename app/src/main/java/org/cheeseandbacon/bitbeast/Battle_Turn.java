...
public class Battle_Turn {
    ...
    public Battle_Turn (short get_damage, short get_strength_attacker, short get_dexterity_attacker,

                        short get_stamina_attacker, short get_strength_defender, short get_dexterity_defender,
                        short get_stamina_defender) {
        damage = get_damage;
