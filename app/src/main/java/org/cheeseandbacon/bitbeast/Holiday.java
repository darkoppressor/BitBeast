...
public class Holiday {
    ...
    public static short get () {
        ...
        if (now.get(Calendar.MONTH) == Calendar.FEBRUARY && now.get(Calendar.DAY_OF_MONTH) >= 8 &&
            now.get(Calendar.DAY_OF_MONTH) <= 14) {
            return VALENTINES;
        } else if (now.get(Calendar.MONTH) == Calendar.MARCH && now.get(Calendar.DAY_OF_MONTH) >= 11 &&
                   now.get(Calendar.DAY_OF_MONTH) <= 17) {
            return ST_PATRICKS;
        } else if (now.get(Calendar.MONTH) == Calendar.APRIL && now.get(Calendar.DAY_OF_MONTH) >= 24 &&
                   now.get(Calendar.DAY_OF_MONTH) <= 30) {
            return EASTER;
        } else if (now.get(Calendar.MONTH) == Calendar.OCTOBER && now.get(Calendar.DAY_OF_MONTH) >= 18 &&
                   now.get(Calendar.DAY_OF_MONTH) <= 31) {
            return HALLOWEEN;
        } else if (now.get(Calendar.MONTH) == Calendar.DECEMBER && now.get(Calendar.DAY_OF_MONTH) >= 1 &&
                   now.get(Calendar.DAY_OF_MONTH) <= 30) {
            return CHRISTMAS;
        } else {
            return NONE;
