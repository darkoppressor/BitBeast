...
public class Image {
    ...
    public Image (Context context) {
        ...
        perma_item_duckie = new Sprite_Data(BitmapFactory.decodeResource(res, R.drawable.food_icon_duckie), 0, 1,
                                            false);
        perma_item_bunny = new Sprite_Data(BitmapFactory.decodeResource(res, R.drawable.food_icon_bunny), 0, 1, false);
        perma_item_beach_ball = new Sprite_Data(BitmapFactory.decodeResource(res, R.drawable.food_icon_beach_ball), 0,
                                                1, false);
        perma_item_robot = new Sprite_Data(BitmapFactory.decodeResource(res, R.drawable.food_icon_robot), 0, 1, false);
        perma_item_computer = new Sprite_Data(BitmapFactory.decodeResource(res, R.drawable.food_icon_computer), 0, 1,
                                              false);
        perma_item_at = new Sprite_Data(BitmapFactory.decodeResource(res, R.drawable.food_icon_at), 0, 1, false);
        perma_item_berry_bush = new Sprite_Data(BitmapFactory.decodeResource(res, R.drawable.food_icon_berry_bush), 0,
                                                1, false);
        ...
        perma_item_trampoline = new Sprite_Data(BitmapFactory.decodeResource(res, R.drawable.food_icon_trampoline), 0,
                                                1, false);
        ...
        perma_item_barbell = new Sprite_Data(BitmapFactory.decodeResource(res, R.drawable.food_icon_barbell), 0, 1,
                                             false);
        perma_item_chest = new Sprite_Data(BitmapFactory.decodeResource(res, R.drawable.food_icon_chest), 0, 1, false);
        perma_item_jump_rope = new Sprite_Data(BitmapFactory.decodeResource(res, R.drawable.food_icon_jump_rope), 0, 1,
                                               false);
        ...
        perma_item_holiday_valentines = new Sprite_Data(BitmapFactory.decodeResource(res,
                                                                                     R.drawable.
                                                                                     food_icon_holiday_valentines), 0,
                                                        1, false);
        perma_item_holiday_st_patricks = new Sprite_Data(BitmapFactory.decodeResource(res,
                                                                                      R.drawable.
                                                                                      food_icon_holiday_st_patricks), 0,
                                                         1, false);
        perma_item_holiday_easter = new Sprite_Data(BitmapFactory.decodeResource(res,
                                                                                 R.drawable.food_icon_holiday_easter),
                                                    0, 1, false);
        perma_item_holiday_halloween = new Sprite_Data(BitmapFactory.decodeResource(res,
                                                                                    R.drawable.
                                                                                    food_icon_holiday_halloween), 0, 1,
                                                       false);
        perma_item_holiday_christmas = new Sprite_Data(BitmapFactory.decodeResource(res,
                                                                                    R.drawable.
                                                                                    food_icon_holiday_christmas), 8, 3,
                                                       false);
        ...
        lit_christmas_tree = new Sprite_Data(BitmapFactory.decodeResource(res, R.drawable.lit_christmas_tree), 8, 3,
                                             false);
        ...
        object_powerup_spawner_on = new Sprite_Data(BitmapFactory.decodeResource(res,
                                                                                 R.drawable.object_powerup_spawner_on),
                                                    12, 2, false);
        object_powerup_spawner_off = new Sprite_Data(BitmapFactory.decodeResource(res,
                                                                                  R.drawable.object_powerup_spawner_off),
                                                     16, 2, false);
        object_powerup_ball_speed_up = new Sprite_Data(BitmapFactory.decodeResource(res,
                                                                                    R.drawable.
                                                                                    object_powerup_ball_speed_up), 1, 4,
                                                       false);
        object_powerup_ball_speed_down = new Sprite_Data(BitmapFactory.decodeResource(res,
                                                                                      R.drawable.
                                                                                      object_powerup_ball_speed_down),
                                                         3, 4, false);
        object_powerup_ball_extra = new Sprite_Data(BitmapFactory.decodeResource(res,
                                                                                 R.drawable.object_powerup_ball_extra),
                                                    2, 4, false);
        object_powerup_ball_noclip = new Sprite_Data(BitmapFactory.decodeResource(res,
                                                                                  R.drawable.object_powerup_ball_noclip),
                                                     2, 4, false);
        object_powerup_life = new Sprite_Data(BitmapFactory.decodeResource(res, R.drawable.object_powerup_life), 2, 4,
                                              false);

        overlay_clean_yard = new Sprite_Data(BitmapFactory.decodeResource(res, R.drawable.overlay_clean_yard), 0, 1,
                                             false);
        overlay_clean_pet = new Sprite_Data(BitmapFactory.decodeResource(res, R.drawable.overlay_clean_pet), 0, 1,
                                            false);
