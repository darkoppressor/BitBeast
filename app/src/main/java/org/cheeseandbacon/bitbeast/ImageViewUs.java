...
public class ImageViewUs extends ImageView {
    ...
    @Override protected void onAnimationEnd () {
        ...
        if (attacking) {
            ...
            Activity_Battle.set_pet_stats(ab.getResources(), (TextView) ab.findViewById(R.id.battle_text_us),
                                          (TextView) ab.findViewById(R.id.battle_text_them), ab.us, ab.them,
                                          ab.strength_us, ab.dexterity_us, ab.stamina_us, ab.strength_them,
                                          ab.dexterity_them, ab.stamina_them);
