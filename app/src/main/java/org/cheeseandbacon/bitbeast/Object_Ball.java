...
public class Object_Ball {
    ...
    public Object_Ball (Image image, View view, float get_x, float get_y, float get_move_speed_x,

                        float get_move_speed_y, long get_counter_move, int get_noclip) {
        sprite = null;
    ...
    public int handle_events_workout (View view, ArrayList<Object_Paddle> paddles, Vibrator vibrator) {
        ...
        if (noclip == 0) {
            for (int i = 0; i < paddles.size(); i++) {
                ...
                if (paddle_hit) {
                    Sound_Manager.playSound(view.getContext(), Sound.GAME_HIT_PADDLE);
        ...
        if (x < 0) {
            Sound_Manager.playSound(view.getContext(), Sound.GAME_HIT_WALL);
    ...
    public boolean move_bricks (Game_Bricks game, View view, Image image, ArrayList<Object_Paddle> paddles,
                                ArrayList<Object_Brick> bricks, ArrayList<Object_Powerup> powerups, Vibrator vibrator) {
    ...
    public boolean handle_events_bricks (Game_Bricks game, View view, Image image, ArrayList<Object_Paddle> paddles,
                                         ArrayList<Object_Brick> bricks, ArrayList<Object_Powerup> powerups,
                                         Vibrator vibrator) {
        boolean ball_in_play = true;
        Resources res = view.getResources();
        ...
        for (int i = 0; i < bricks.size(); i++) {
            ...
            if (noclip == 0) {
                brick_hit = handle_collision(bricks.get(i).x, bricks.get(i).y, bricks.get(i).w, bricks.get(i).h,
                                             Direction.NONE, res);
            } else {
            ...
            if (brick_hit) {
                Sound_Manager.playSound(view.getContext(), Sound.GAME_HIT_BRICK);
                ...
                if (RNG.random_range(0, 99) < POWERUP_CHANCE) {
                    ...
                    float speed_x = Px.px(res,
                                          (float) RNG.random_range(Object_Powerup.SPEED_MIN, Object_Powerup.SPEED_MAX));
                    ...
                    Sound_Manager.playSound(view.getContext(), Sound.POWERUP_SPAWN);
