...
public class Pet_Status {
    ...
    public Bundle write_bundle_battle_data (String key_prefix) {
        ...
        for (int i = Equipment.SLOT_BEGIN; i < Equipment.SLOT_END; i++) {
            if (equipment_slots.get(i) == null) {
                ...
                bundle.putString(key_prefix + "equipment_slot_" + i + "_description",
                                 equipment_slots.get(i).description);
                ...
                bundle.putShort(key_prefix + "equipment_slot_" + i + "_buff_hunger",
                                equipment_slots.get(i).buff_hunger);
                bundle.putShort(key_prefix + "equipment_slot_" + i + "_buff_thirst",
                                equipment_slots.get(i).buff_thirst);
                ...
                bundle.putDouble(key_prefix + "equipment_slot_" + i + "_buff_weight",
                                 equipment_slots.get(i).buff_weight);
                ...
                bundle.putFloat(key_prefix + "equipment_slot_" + i + "_buff_energy_regen",
                                equipment_slots.get(i).buff_energy_regen);
                bundle.putFloat(key_prefix + "equipment_slot_" + i + "_buff_strength_regen",
                                equipment_slots.get(i).buff_strength_regen);
                bundle.putFloat(key_prefix + "equipment_slot_" + i + "_buff_dexterity_regen",
                                equipment_slots.get(i).buff_dexterity_regen);
                bundle.putFloat(key_prefix + "equipment_slot_" + i + "_buff_stamina_regen",
                                equipment_slots.get(i).buff_stamina_regen);
                bundle.putShort(key_prefix + "equipment_slot_" + i + "_buff_energy_max",
                                equipment_slots.get(i).buff_energy_max);
                bundle.putShort(key_prefix + "equipment_slot_" + i + "_buff_strength_max",
                                equipment_slots.get(i).buff_strength_max);
                bundle.putShort(key_prefix + "equipment_slot_" + i + "_buff_dexterity_max",
                                equipment_slots.get(i).buff_dexterity_max);
                bundle.putShort(key_prefix + "equipment_slot_" + i + "_buff_stamina_max",
                                equipment_slots.get(i).buff_stamina_max);
                bundle.putInt(key_prefix + "equipment_slot_" + i + "_buff_death", equipment_slots.get(i).buff_death);
                bundle.putInt(key_prefix + "equipment_slot_" + i + "_buff_magic_find",
                              equipment_slots.get(i).buff_magic_find);
            }
        }
    ...
    public void read_bundle_battle_data (String key_prefix, Bundle bundle) {
        ...
        for (int i = Equipment.SLOT_BEGIN; i < Equipment.SLOT_END; i++) {
            ...
            if (slot_filled) {
                ...
                equipment_slots.get(i).description = bundle.getString(key_prefix + "equipment_slot_" + i +
                                                                      "_description");
                ...
                equipment_slots.get(i).buff_hunger = bundle.getShort(key_prefix + "equipment_slot_" + i +
                                                                     "_buff_hunger");
                equipment_slots.get(i).buff_thirst = bundle.getShort(key_prefix + "equipment_slot_" + i +
                                                                     "_buff_thirst");
                ...
                equipment_slots.get(i).buff_weight = bundle.getDouble(key_prefix + "equipment_slot_" + i +
                                                                      "_buff_weight");
                ...
                equipment_slots.get(i).buff_energy_regen = bundle.getFloat(key_prefix + "equipment_slot_" + i +
                                                                           "_buff_energy_regen");
                equipment_slots.get(i).buff_strength_regen = bundle.getFloat(key_prefix + "equipment_slot_" + i +
                                                                             "_buff_strength_regen");
                equipment_slots.get(i).buff_dexterity_regen = bundle.getFloat(key_prefix + "equipment_slot_" + i +
                                                                              "_buff_dexterity_regen");
                equipment_slots.get(i).buff_stamina_regen = bundle.getFloat(key_prefix + "equipment_slot_" + i +
                                                                            "_buff_stamina_regen");
                equipment_slots.get(i).buff_energy_max = bundle.getShort(key_prefix + "equipment_slot_" + i +
                                                                         "_buff_energy_max");
                equipment_slots.get(i).buff_strength_max = bundle.getShort(key_prefix + "equipment_slot_" + i +
                                                                           "_buff_strength_max");
                equipment_slots.get(i).buff_dexterity_max = bundle.getShort(key_prefix + "equipment_slot_" + i +
                                                                            "_buff_dexterity_max");
                equipment_slots.get(i).buff_stamina_max = bundle.getShort(key_prefix + "equipment_slot_" + i +
                                                                          "_buff_stamina_max");
                equipment_slots.get(i).buff_death = bundle.getInt(key_prefix + "equipment_slot_" + i + "_buff_death");
                equipment_slots.get(i).buff_magic_find = bundle.getInt(key_prefix + "equipment_slot_" + i +
                                                                       "_buff_magic_find");
            } else {
    ...
    public void dexterity_max_increase () {
        ...
        if (branch == Pet_Type.BRANCH_PTERO) {
            ...
            increase = STAT_GAIN_RANDOM_SECONDARY;
        } else if (branch == Pet_Type.BRANCH_NONE || branch == Pet_Type.BRANCH_APATO ||
                   branch == Pet_Type.BRANCH_STEGO) {
            increase = STAT_GAIN_RANDOM_TERTIARY;
        }
    ...
    public void stamina_max_increase () {
        ...
        if (branch == Pet_Type.BRANCH_STEGO || branch == Pet_Type.BRANCH_TRICERA) {
            ...
            increase = STAT_GAIN_RANDOM_SECONDARY;
        } else if (branch == Pet_Type.BRANCH_NONE || branch == Pet_Type.BRANCH_PTERO ||
                   branch == Pet_Type.BRANCH_TYRANNO) {
            increase = STAT_GAIN_RANDOM_TERTIARY;
        }
    ...
    public String new_equipment (int chance, int base_level, String force_slot) {
        ...
        if (RNG.random_range(0, 99) < chance) {
            ...
            /*if(RNG.random_range(0,999)<5){
                ...
                }while(!Templates.equipment.get(item_index).slot.equals(slot_name) ||
                   !Templates.equipment.get(item_index).unique);
            ...
            int item_level = RNG.random_range(base_level - 2,
                                              base_level + 1 + (int) Math.ceil(0.2 * (double) magic_find));
            ...
            equipment.get(0).bits = (int) Math.ceil(0.5 *
                                                    (double) (equipment.get(0).buff_strength_max +
                                                              equipment.get(0).buff_dexterity_max +
                                                              equipment.get(0).buff_stamina_max));

            if (equipment.get(0).get_buff_names().size() > 0) {
                equipment.get(0).bits = (int) Math.ceil((double) equipment.get(0).bits *
                                                        (double) equipment.get(0).get_buff_names().size() * 1.25);
            }
            ...
            equipment.get(0).full_name = prefix + prefix_spacer +
                                         Strings.first_letter_capital_all_words(equipment.get(0).name) + suffix_spacer +
                                         suffix;
            ///}
        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (get_held_item() == null) {
                    for (int i = perma_items.size() - 1; i >= 0; i--) {
                        if (Collision.check(perma_items.get(i).x, perma_items.get(i).y, perma_items.get(i).w,
                                            perma_items.get(i).h, x, y, Px.px(res, 2), Px.px(res, 2))) {
                            perma_items.get(i).held = true;

                            Sound_Manager.playSound(context, Sound.PERMA_ITEM_GRAB);
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (get_held_item() != null) {
                    ...
                    Sound_Manager.playSound(context, Sound.PERMA_ITEM_DROP);
    ...
    public boolean eligible_for_senior () {
        if (is_well_fed() && is_well_watered() && !sick && temp_is_optimum() && !needs_poop_cleaned() &&
            !needs_bath() && is_happy() && !is_obese() && level >= LEVEL_NEEDED_FOR_SENIOR &&
            get_energy() >= get_energy_max() && get_strength() >= get_strength_max() &&
            get_dexterity() >= get_dexterity_max() && get_stamina() >= get_stamina_max() &&
