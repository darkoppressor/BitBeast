...
public enum Pet_Type {
    ...
    public static BitmapDrawable get_drawable (Resources res, Pet_Type type, boolean flipped, float scale_x,
                                               float scale_y) {
        Bitmap bitmap;
        ...
        if (flipped) {
            ...
            bitmap_final = Bitmap.createBitmap(bitmap_final, 0, 0, bitmap_final.getWidth(), bitmap_final.getHeight(), m,
                                               false);
        }
