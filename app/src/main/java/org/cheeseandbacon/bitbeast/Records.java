...
public class Records {
    ...
    public void add_pet (String name, int bits, long age, Pet_Type type, Age_Tier age_tier, double weight,
                         short strength_max, short dexterity_max, short stamina_max, int battles_won, int battles_lost,
                         int battles_won_sp, int battles_lost_sp, int level) {
