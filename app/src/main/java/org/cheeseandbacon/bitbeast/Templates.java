...
public class Templates {
    ...
    public static synchronized void create_food_lists () {
        for (int i = 0; i < food.size(); i++) {
            ...
            } else if (food.get(i).store_section == Store_Section.PERMA) {} else {
                food_food.add(food.get(i));
            }
        }
    }
    ...
    public static synchronized void load_template_equipment (ArrayList<String> data, Context context, Resources res) {
        ...
        while (data.size() > 0) {
            ...
            // plural name
                     ...
                     line.toLowerCase(Locale.US).startsWith(plural_name.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // prefix article
                     ...
                     line.toLowerCase(Locale.US).startsWith(prefix_article.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // resource id
                     ...
                     line.toLowerCase(Locale.US).startsWith(resource_id.toLowerCase(Locale.US))) {
                // Clear the data name.
                line = line.substring(resource_id.length(), line.length());

                equipment.get(equipment.size() - 1).resource_id = res.getIdentifier(context.getPackageName() +
                                                                                    ":drawable/" + line, null, null);
            }
            // slot
            ...
            // description
                     ...
                     line.toLowerCase(Locale.US).startsWith(description.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // buff_hunger
                     ...
                     line.toLowerCase(Locale.US).startsWith(buff_hunger.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // buff_thirst
                     ...
                     line.toLowerCase(Locale.US).startsWith(buff_thirst.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // buff_weight
                     ...
                     line.toLowerCase(Locale.US).startsWith(buff_weight.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // buff_energy_regen
                     ...
                     line.toLowerCase(Locale.US).startsWith(buff_energy_regen.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // buff_strength_regen
                     ...
                     line.toLowerCase(Locale.US).startsWith(buff_strength_regen.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // buff_dexterity_regen
                     ...
                     line.toLowerCase(Locale.US).startsWith(buff_dexterity_regen.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // buff_stamina_regen
                     ...
                     line.toLowerCase(Locale.US).startsWith(buff_stamina_regen.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // buff_energy_max
                     ...
                     line.toLowerCase(Locale.US).startsWith(buff_energy_max.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // buff_strength_max
                     ...
                     line.toLowerCase(Locale.US).startsWith(buff_strength_max.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // buff_dexterity_max
                     ...
                     line.toLowerCase(Locale.US).startsWith(buff_dexterity_max.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // buff_stamina_max
                     ...
                     line.toLowerCase(Locale.US).startsWith(buff_stamina_max.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // buff_magic_find
                     ...
                     line.toLowerCase(Locale.US).startsWith(buff_magic_find.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // If the line ends the equipment.
                     ...
                     line.toLowerCase(Locale.US).contains("</equipment>".toLowerCase(Locale.US))) {
                return;
            }
        }
    }
    ...
    public static synchronized void load_template_item (ArrayList<String> data, Context context, Resources res) {
        ...
        while (data.size() > 0) {
            ...
            // resource id
                ...
                food.get(food.size() - 1).resource_id = res.getIdentifier(context.getPackageName() + ":drawable/" +
                                                                          line, null, null);
            }
            // cost
            ...
            // store_section
                     ...
                     line.toLowerCase(Locale.US).startsWith(store_section.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // primary_effect
                     ...
                     line.toLowerCase(Locale.US).startsWith(primary_effect.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // is medicine
                     ...
                     line.toLowerCase(Locale.US).startsWith(is_medicine.toLowerCase(Locale.US))) {
                // Clear the data name.
            ...
            // cannot be favorite
                     ...
                     line.toLowerCase(Locale.US).startsWith(cannot_be_favorite.toLowerCase(Locale.US))) {
                // Clear the data name.
    ...
    public static synchronized void load_template_bricks (ArrayList<String> data, int width, int height,
