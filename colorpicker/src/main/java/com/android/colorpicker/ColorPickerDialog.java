 ...
 * Added custom alert dialog theme resource ID
 */
...
public class ColorPickerDialog extends DialogFragment implements OnColorSelectedListener {
    ...
    protected int mThemeId = R.style.ColorPickerDialogDefault;
    ...
    public static ColorPickerDialog newInstance(int titleResId, int themeResId, int[] colors, int selectedColor,
            int columns, int size) {
        ColorPickerDialog ret = new ColorPickerDialog();
        ret.initialize(titleResId, themeResId, colors, selectedColor, columns, size);
        return ret;
    }

    public void initialize(int titleResId, int themeResId, int[] colors, int selectedColor, int columns, int size) {
        setArguments(titleResId, themeResId, columns, size);
        setColors(colors, selectedColor);
    }

    public void setArguments(int titleResId, int themeResId, int columns, int size) {
        Bundle bundle = new Bundle();
        bundle.putInt(KEY_TITLE_ID, titleResId);
        bundle.putInt(KEY_THEME_ID, themeResId);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mAlertDialog = new AlertDialog.Builder(activity, mThemeId)
